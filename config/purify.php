    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'b,strong,i,em,u,s,del,a[href|title|rel|target],br,p,span',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,button,link,meta',
        ...
        'rich-text' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|rel|target],ul,ol,li,p[style],br,span[style],img[width|height|alt|src|loading],blockquote,hr,figure,figcaption,table,thead,tbody,tr,th,td',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,button,link,meta',
        ...
        'developer' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|rel|target],ul,ol,li,p[style|class],br,span[style|class],img[width|height|alt|src|loading|class],blockquote,hr,figure,figcaption,table[class],thead,tbody,tr,th,td,div[class],section[class],article[class],aside[class],header[class],footer[class],nav[class]',
            'HTML.ForbiddenElements' => 'script,iframe,object,embed,form,input,button,link,meta',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding,padding-left,padding-right,padding-top,padding-bottom,margin,margin-left,margin-right,margin-top,margin-bottom,color,background-color,background,text-align,border,border-radius,width,max-width,height,display,float',
            'AutoFormat.AutoParagraph' => false,
