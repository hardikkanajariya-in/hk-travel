<div class="space-y-4">
    <div class="flex items-center justify-between gap-3">
        ...
        <x-ui.button :href="route('admin.blog.categories.create')" wire:navigate>{{ __('New category') }}</x-ui.button>
    </div>
    ...
    <x-ui.card>
        <x-ui.table>
            ...
            @empty
                <tr><td colspan="4" class="px-3 py-6 text-center text-gray-500">{{ __('No categories.') }}</td></tr>
            @endforelse
        </x-ui.table>
